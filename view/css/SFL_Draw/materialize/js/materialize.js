    ...
    var FormSelect = function(_Component20) {
        ...
        _createClass(FormSelect, [{
                ...
                if (!$(option).hasClass('disabled') && !$(option).hasClass('optgroup') && key.length) {
                    ...
                    if (this.isMultiple) {
                        ...
                        if (placeholderOption.length) {
                            ...
                            placeholderOption.find('input[id^="isAnalysed"][type="checkbox"]').prop('checked', false);
            ...
            value: function _toggleEntryFromArray(key) {
                ...
                $optionLi.find('input[id^="isAnalysed"][type="checkbox"]').prop('checked', notAdded);
            ...
            value: function _setSelectedStates() {
                ...
                for (var key in this._valueDict) {
                    ...
                    $(option.optionEl).find('input[id^="isAnalysed"][type="checkbox"]').prop('checked', optionIsSelected);
                    if (optionIsSelected) {
