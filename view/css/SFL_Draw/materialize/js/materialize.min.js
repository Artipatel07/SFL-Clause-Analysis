            ...
            t = function(t) {
                ...
                return _inherits(n, Component), _createClass(n, [{ key: "destroy", value: function() { this._removeEventHandlers(), this._removeDropdown(), this.el.M_FormSelect = void 0 } }, {
                    ...
                    value: function(t) {
                        ...
                        if (!d(e).hasClass("disabled") && !d(e).hasClass("optgroup") && i.length) {
                            ...
                            if (this.isMultiple) {
                                ...
                                s.length && (s.removeClass("selected"), s.find('input[id^="isAnalysed"][type="checkbox"]').prop("checked", !1), this._toggleEntryFromArray(s[0].id)), n = this._toggleEntryFromArray(i)
                    ...
                    value: function(t) {
                        ...
                        return e ? this._keysSelected[t] = !0 : delete this._keysSelected[t], i.toggleClass("selected", e), i.find('input[id^="isAnalysed"][type="checkbox"]').prop("checked", e), i.prop("selected", e), e
                    }
                }, {
                    ...
                    value: function() {
                        for (var t in this._keysSelected = {}, this._valueDict) {
                            ...
                            d(e.optionEl).find('input[id^="isAnalysed"][type="checkbox"]').prop("checked", i), i ? (this._activateOption(d(this.dropdownOptions), d(e.optionEl)), this._keysSelected[t] = !0) : d(e.optionEl).removeClass("selected")
                        }
                    }
